...
from SAT.sat.models import GraphTransformer
from SAT.sat.data import GraphDataset
from SAT.sat.utils import count_parameters
from SAT.sat.metric import accuracy_SBM
from SAT.sat.position_encoding import POSENCODINGS
from SAT.sat.gnn_layers import GNN_TYPES
...
def load_args():
    ...
    parser.add_argument('--abs-pe-dim', type=int, default=7, help='dimension for absolute PE')
    ...
    parser.add_argument('--k-hop', type=int, default=3, help="number of layers for GNNs")
    parser.add_argument('--weight-class', default=True, help='weight classes or not')
